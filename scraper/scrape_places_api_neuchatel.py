"""
Extraction des agences immobilières du Canton de Neuchâtel via l'API Google Places.
...
Usage:
    python scrape_places_api_neuchatel.py --api-key VOTRE_CLE [--output fichier.csv]

    Ou via variable d'environnement :
    GOOGLE_PLACES_API_KEY=VOTRE_CLE python scrape_places_api_neuchatel.py
"""
...
QUERIES = [
    # Grandes villes
    "agence immobilière Neuchâtel",
    "agence immobilière La Chaux-de-Fonds",
    "agence immobilière Le Locle",
    # Villes moyennes
    "agence immobilière Boudry",
    "agence immobilière Colombier Neuchâtel",
    "agence immobilière Cortaillod",
    "agence immobilière Peseux Neuchâtel",
    "agence immobilière Hauterive Neuchâtel",
    "agence immobilière Saint-Blaise Neuchâtel",
    "agence immobilière Marin-Epagnier",
    "agence immobilière Bevaix",
    "agence immobilière Fleurier",
    "agence immobilière Couvet",
    "agence immobilière Môtiers Neuchâtel",
    "agence immobilière Travers Neuchâtel",
    # Littoral
    "agence immobilière Saint-Aubin-Sauges",
    "agence immobilière Gorgier",
    # Val-de-Ruz
    "agence immobilière Val-de-Ruz",
    "agence immobilière Cernier",
    "agence immobilière Fontainemelon",
    # Val-de-Travers
    "agence immobilière Val-de-Travers",
    # Recherches génériques
    "agence immobilière Canton de Neuchâtel",
    "régie immobilière Canton de Neuchâtel",
    "courtier immobilier Neuchâtel",
    "immobilier Neuchâtel Suisse",
]
...
def scrape(api_key: str, output: str = "agences_immobilieres_neuchatel.csv"):
...
def main():
    parser = argparse.ArgumentParser(
        description="Extraction agences immobilières Neuchâtel via Google Places API"
    )
    parser.add_argument(
        "--api-key",
    ...
    parser.add_argument(
        "--output", "-o",
        default="agences_immobilieres_neuchatel.csv",
        help="Fichier CSV de sortie (défaut: agences_immobilieres_neuchatel.csv)",
    )
