"""
Extraction des agences immobilières du Canton du Valais via l'API Google Places.
...
Usage:
    python scrape_places_api_valais.py --api-key VOTRE_CLE [--output fichier.csv]

    Ou via variable d'environnement :
    GOOGLE_PLACES_API_KEY=VOTRE_CLE python scrape_places_api_valais.py
"""
...
def scrape(api_key: str, output: str = "agences_immobilieres_valais.csv"):
...
def main():
    parser = argparse.ArgumentParser(
        description="Extraction agences immobilières Valais via Google Places API"
    )
    parser.add_argument(
        "--api-key",
