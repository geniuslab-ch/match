"""
Extraction des agences immobilières du Canton de Neuchâtel via Google Maps (Playwright).
...
Usage:
    ...
    python scrape_gmaps_neuchatel.py [--output fichier.csv] [--headless]
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Scraping agences immobilières Neuchâtel via Google Maps (Playwright)"
    )
    parser.add_argument(
        "--output", "-o",
