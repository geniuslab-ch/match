"""
Extraction des agences immobilières du Canton de Genève via Google Maps (Playwright).
...
Usage:
    ...
    python scrape_gmaps_geneve.py [--output fichier.csv] [--headless]
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Scraping agences immobilières Genève via Google Maps (Playwright)"
    )
    parser.add_argument(
        "--output", "-o",
