"""
Extraction des agences immobilières du Canton de Fribourg via l'API Google Places.
...
Usage:
    python scrape_places_api_fribourg.py --api-key VOTRE_CLE [--output fichier.csv]

    Ou via variable d'environnement :
    GOOGLE_PLACES_API_KEY=VOTRE_CLE python scrape_places_api_fribourg.py
"""
...
def scrape(api_key: str, output: str = "agences_immobilieres_fribourg.csv"):
...
def main():
    parser = argparse.ArgumentParser(
        description="Extraction agences immobilières Fribourg via Google Places API"
    )
    parser.add_argument(
        "--api-key",
